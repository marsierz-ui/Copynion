...
|-------|--------------|--------|
| 1. **Observation** | Records which application and window you are working in | **Implemented** |
...
- **No screenshots, no keylogging, no clipboard, no OCR, no accessibility-tree
  scraping.** Stage 1 records *that* you used an app, not what you typed into it.
...
- **Your data, exportable and deletable**: `copynion export`, `copynion purge`,
  `copynion purge --titles-only`, `copynion audit`.
...
Partly — and it is worth knowing what you would be reinventing.
